...
## Colors colors = c("slateblue1", "slateblue2", "slateblue3", "slateblue4")

##colors = c("skyblue2", "royalblue1", "royalblue4", "navy")

##

colors = c("slateblue1", "slateblue2", "slateblue3", "slateblue4")
...
#map.text("county","MASSACHUSETTS", exact=TRUE, labels=mafips$polyname,add=TRUE, move=TRUE)
...
dev.copy(jpeg,filename="MassCountyProbGambRatesMap_Blue.jpg");
dev.off ();
