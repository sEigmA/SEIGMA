    ...
    mainPanel(
      ...
      tabsetPanel(
        tabPanel("About", 
                 ...
                 p(strong("The SEIGMA Suicide App"), "displays the age-adjusted suicide rate for Massachusetts by counties for a given year or multiple years from 1999 to 2011. Toggle between tabs to visualize the data differently. ",
                   tags$br(),
                   ##tags$ul and tags$li are to create bullet points using HTML
                   tags$ul(
