...
mar_data2$Region  <- ifelse(!is.na(mar_data2$County),as.character(mar_data2$County),as.character(mar_data2$Region))
...
mar_data2 <- read.csv("marriagedata.csv")[,-c(1:4)]

colnames(mar_data2)[4:13] <- c("Never_Married", "Never_Married_pct", "Now_Married", "Now_Married_pct",
                               "Separated", "Separated_Pct", "Widowed", "Widowed_pct", "Divorced",
                               "Divorced_pct")

## make proportions into percentages
mar_data2$Never_Married_Pct <- 100*mar_data2$Never_Married/mar_data2$Population
mar_data2$Now_Married_Pct <- 100*mar_data2$Now_Married/mar_data2$Population
mar_data2$Separated_Pct <- 100*mar_data2$Separated/mar_data2$Population
mar_data2$Widowed_Pct <- 100*mar_data2$Widowed/mar_data2$Population
mar_data2$Divorced_Pct <- 100*mar_data2$Divorced/mar_data2$Population
