  ...
  map_dat <- reactive({
   ...
   # browser()
    ...
    if(input$var == "Married_Pct"){
      ...
      marmap_dat <- filter(map_dat, Var==input$var)
    ...
    if(input$var == "Never_Married_Pct"){
      ...
      ## subset the data by the year selected
      nevmap_dat <- filter(map_dat, Var==input$var)
    ...
    if(input$var == "Separated_Pct"){
      ...
      ## subset the data by the year selected
      sepmap_dat <- filter(map_dat, Var==input$var)
    ...
    if(input$var == "Widowed_Pct"){
      ...
      ## subset the data by the year selected
      widmap_dat <- filter(map_dat, Var==input$var)
    ...
    if(input$var == "Divorced_Pct"){
      ...
      ## subset the data by the year selected
      divmap_dat <- filter(map_dat, Var==input$var)
