  ...
  fluidPage(
    ...
    sidebarLayout(
      sidebarPanel(width=4,
                   ...
                   helpText(a("Data Source: American Community Survey: Table S2502", href="http://factfinder.census.gov/faces/tableservices/jsf/pages/productview.xhtml?pid=ACS_14_5YR_S2502&prodType=table",
