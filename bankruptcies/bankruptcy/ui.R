    ...
    mainPanel(
      ...
      tabsetPanel(
        ...
        tabPanel("More Info", 
                 ...
                 tags$br(),
                 p(strong("Chapter 7"), 
                   " - This chapter deals with liquidation, the sale of a debtor's nonexempt property and the distribution of the funds to the creditors.  In order to file a chapter 7 bankruptcy a debtor must pass a 'means test' given by the court, which evaluates their income and expenses."),
                 tags$br(),
                 p(strong("Chapter 11"), 
                   " - This chapter deals with corporations or partnerships.  In order to file a chapter 11 bankruptcy a corporation must propose a reorganization plan which keeps the business alive by repaying debt over time."),
                 tags$br(),
                 p(strong("Chapter 12"), 
