    ...
    mainPanel(
      ...
      tabsetPanel(
        ...
        tabPanel("More Info", 
                 ...
                 tags$br(),
                 p(strong("Chapter 7"), 
                   " - This chapter deals with liquidation, the sale of a debtor's (this may be a business or an individual depending on the nature of the debt) nonexempt property and the distribution of the funds to the creditors.  In order to file a chapter 7 bankruptcy a debtor must pass a 'means test' given by the court, which evaluates their income and expenses."),
                 tags$br(),
                 p(strong("Chapter 11"), 
